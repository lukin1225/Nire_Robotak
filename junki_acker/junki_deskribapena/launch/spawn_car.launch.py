...
def generate_launch_description():
    ...
    pkg_sim_car = get_package_share_directory('junki_deskribapena')
    xacro_file = os.path.join(get_package_share_directory('junki_deskribapena'), 'robot/', 'junki_acker.urdf.xacro')
    assert os.path.exists(xacro_file), "The xacro doesnt exist in "+str(xacro_file)

    install_dir = get_package_prefix('junki_deskribapena')
